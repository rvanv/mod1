...
if present_value >= loan.get("loan_price"):
    print(f"The loan is worth at least the cost to buy")
else: 
...
future_value, remaining_months = new_loan['future_value'], new_loan['remaining_months']
...
for loan_offer in loans:
    if(loan_offer['loan_price'] <= 500):
        inexpensive_loans.append(loan_offer)
